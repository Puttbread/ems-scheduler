        ...
        <div className="main">
          <div className="card">
            ...
            <p style={{ color: 'var(--muted)' }}>
              Preferences can be set once your administrator opens a new 6-week cycle.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="main">
        ...
        {prefs.carried_forward_from && (
          <div className="warn-note">
            Showing preferences carried forward from a prior cycle. Review and save to confirm, or
            adjust anything that's changed.
          </div>
        )}
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--muted)', fontSize: '0.85rem' }}>
            Maximum number of shifts you're willing to work in a row (with less than 24 hours off
            between them) before needing a longer break. This is strictly enforced.
          </p>
          <select
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--muted)', fontSize: '0.85rem' }}>
            The scheduler will try to pair you with these coworkers, but a full schedule always
            comes first.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 4 }}>
            {staff.map((s) => (
